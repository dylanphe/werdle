  ...
  // look for key pressed down and trigger keypress handler event [tabIndex necessary]
    ...
    <GlobalStyles />
      <div tabIndex="0" onKeyDown={handleKeypress}>
        ...
        <Modal className='inst-modal' size="lg" show={showInvalid} onHide={() => setShowInvalid(false)}>
          <Modal.Header closeButton>
        ...
        <Modal className='inst-modal' size="lg" show={showWin} onHide={() => setShowWin(false)}>
          <Modal.Header closeButton>
        ...
        <Modal className='inst-modal' size="lg" show={showLoss} onHide={() => setShowLoss(false)}>
          <Modal.Header closeButton>
        ...
        <div id="Gamegrid">
          <Gameboard letters={letters} mode="4"/>
        </div>
